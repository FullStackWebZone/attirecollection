                ...
                <td class="quantity product-single" style="text-align:center;">
                    ...
                    <span class="buttons">
                        <div class="quantity product-quantity">
                            ...
                            <input  type="number" class="form-control qty in_xs quantity-field quantity_field" data-rowid="<?php echo $items['rowid']; ?>" data-limit='no' value="<?php echo $items['qty']; ?>" id='qty<?php echo mt_rand(1,50); ?>' onblur="check_ok(this);" />
