...
<section class="page-section color">
    <div class="container box_shadow">
        ...
        <div class="overflowed">
            <div class="col-md-12 error_msg" id="error_msg">
                <p>Minimum Order 5 BHD for the delivery</p>
            </div>
            <a class="btn btn-theme-dark" href="<?php echo base_url(); ?>home/cancel_order">
                <?php echo translate('cancel_order'); ?>
            </a>
            <span class="btn btn-theme pull-right disabled order_btn" id="order_place_btn">
...
<script>
    ...
    function load_payments() {
        ...
        /*$('.delivery_address').find('.required').each(function(){
            ...
            if($(this).hasClass('country') || $(this).is('input')){
                ...
                if($(this).val() == ''){
                    ...
                    if($(this).hasClass('country')){
                       console.log($(this));
                        $('.country .selectpicker').css('border-color', 'rgb(147, 30, 205)');
                    } else {
    ...
    function radio_check(id) {
        ...
        $("#benefitPay").prop("checked", false);
        $("#benefitApp").prop("checked", false);
...
<script>
    ...
    $(".order_btn").click(function(e) {
        ...
        var sub_total = total.substring(3, 12);
        if (parseFloat(sub_total) > parseFloat("5.00")) {
            
            $('#order_place_btn').attr('enabled', true);
            $("#order_place_btn").attr('onClick', 'cart_submission(this)');
        } else {
            $('#error_msg').show();
            $('#order_place_btn').attr('disabled', true);
            $("#order_place_btn").removeAttr('onClick', 'cart_submission(this)');
        }
    });
</script>