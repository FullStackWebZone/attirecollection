    ...
    <div class="row product-single">
        ...
        <div class="col-md-4 col-sm-4 col-xs-12">
            ...
            <div class="media">
            	...
            	<div class="cover" onclick="window.location.href= '<?php echo $this->crud_model->product_link($product_id); ?>'"></div>                

        		<div class="media-link image_delay" data-src="<?php echo $this->crud_model->file_view('product',$product_id,'','','thumb','src','multi','one'); ?>" style="background-image:url('<?php echo img_loading(); ?>');background-size:cover; background-position:center;" onclick="window.location.href= '<?php echo $this->crud_model->product_link($product_id); ?>'">
                    <!--
                    <span onclick="quick_view('<?php echo $this->crud_model->product_link($product_id,'quick'); ?>')">
                    -->
                    <span onclick="window.location.href= '<?php echo $this->crud_model->product_link($product_id); ?>'">
            ...
            <div class="caption">
                ...
                <div class="product-info">
                    ...
                    <p>
                        ...
                        <a href="<?php echo base_url(); ?>home/category/<?php echo $category; ?>/<?php echo $sub_category; ?>-<?php echo $brand; ?>">
