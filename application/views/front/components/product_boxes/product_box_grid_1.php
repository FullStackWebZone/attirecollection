<div class="thumbnail box-style-1 no-padding">
    <div class="media">
        ...
        <div class="media-link image_delay" data-src="<?php echo $this->crud_model->file_view('product',$product_id,'','','thumb','src','multi','one'); ?>" style="background-image:url('<?php echo img_loading(); ?>');background-size:cover;" onclick="window.location.href= '<?php echo $this->crud_model->product_link($product_id); ?>'">
        	<?php
            ...
            <div class="quick-view-sm hidden-xs hidden-sm">
                <!--<span onclick="quick_view('<?php echo $this->crud_model->product_link($product_id,'quick'); ?>')">-->
                    ...
                    <span class="icon-view" data-toggle="tooltip" data-original-title="<?php  echo translate('view_product'); ?>">
