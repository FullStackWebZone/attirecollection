                    ...
                    <li class="hidden-sm hidden-xs <?php if($asset_page=='all_category'){ echo 'active'; } ?>">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                </a>								 								<?php								$all_sub_category = $this->db->get_where('sub_category', array('category' => $row['category_id']))->result_array();								?>								<?php if(count($all_sub_category) > 0): ?>								<ul>								<?php								foreach($all_sub_category as $rows):									if($this->crud_model->if_publishable_subcategory($rows['sub_category_id'])):									?>							 <li>                                <a href="<?php echo base_url(); ?>home/category/<?php echo $row['category_id']; ?>/<?php echo $rows['sub_category_id']; ?>">                                    <?php echo strtoupper($rows['sub_category_name']); ?>									                                </a>								 								<?php								$all_sub_sub_category = $this->db->get_where('sub_sub_category', array('sub_category' => $rows['sub_category_id']))->result_array();								?>								<?php if(count($all_sub_sub_category) > 0): ?>								<ul>								<?php								foreach($all_sub_sub_category as $rowss):									if($this->crud_model->if_publishable_subsubcategory($rowss['sub_sub_category_id'])):									?>							 <li>                                <a href="<?php echo base_url(); ?>home/category/<?php echo $row['category_id']; ?>/<?php echo $rows['sub_category_id']; ?>/<?php echo $rowss['sub_sub_category_id']; ?>">                                    <?php echo strtoupper($rowss['sub_sub_category_name']); ?>									                                </a>																<?php								$all_fourth_sub_category = $this->db->get_where('fourth_sub_category', array('sub_sub_category' => $rowss['sub_sub_category_id']))->result_array();								?>								<?php if(count($all_fourth_sub_category) > 0): ?>								<ul>								<?php								foreach($all_fourth_sub_category as $rowsss):									if($this->crud_model->if_publishable_fourthsubcategory($rowss['fourth_sub_category_id'])):									?>							 <li>                                <a href="<?php echo base_url(); ?>home/category/<?php echo $row['category_id']; ?>/<?php echo $rows['sub_category_id']; ?>/<?php echo $rowss['sub_sub_category_id']; ?>/<?php echo $rowsss['fourth_sub_category_id']; ?>">                                    <?php echo strtoupper($rowsss['fourth_sub_category_name']); ?>									                                </a>								</li>														<?php								endif;								endforeach;							?>							</ul>							<?php endif; ?>								</li>														<?php									endif;								endforeach;							?>							</ul>							<?php endif; ?>								</li>														<?php									endif;								endforeach;							?>							</ul>							<?php endif; ?>	
                            </li>
                            <?php
									endif;
								endforeach;
