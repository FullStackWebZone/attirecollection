    ...
    <div class="container">
        ...
        <div class="partners-carousel">
            <div class="owl-carousel partners2">
                <?php
                $vendor_brands = !empty($this->crud_model->get_vendor_brands($vendor_id)) ? $this->crud_model->get_vendor_brands($vendor_id) : '';
                $brand_ids = array();
                ...
                <div class="p-item p-item-type-zoom">
                    ...
                    <div class="p-item-img">
                        <?php
                                ...
                                ?>
                        <img class="image_delay" src="<?php echo img_loading(); ?>"
                            data-src="<?php echo base_url(); ?>uploads/brand_image/<?php echo $row['logo']; ?>"
                            alt="" />
                        <?php
                                } else {
                                ?>
                        <img class="image_delay" src="<?php echo img_loading(); ?>"
                            data-src="<?php echo base_url(); ?>uploads/brand_image/default.jpg" />
                        <?php
                                }
                                ?>
                    </div>
