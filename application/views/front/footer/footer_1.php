				...
				<div class="col-lg-3 col-md-3 col-sm-sm col-xs-12">
					<div class="widget">
						<a href="<?php echo base_url(); ?>">
                          	<img class="img-responsive img_res" src="<?php echo $this->crud_model->logo('home_bottom_logo'); ?>" alt="">
						</a>
				...
				<div class="col-md-3 col-sm-12 hidden-xs">
					<div class="widget widget-categories">
						...
						<ul>
							...
							?>														<li>								<a href="<?php echo base_url(); ?>home/faq/"><?php echo translate('FAQ');?>								</a>							</li>
														<li> <a href="<?php echo base_url(); ?>home/return_policy/"><?php echo translate('Return Policy'); ?> </a> </li>
					...
					<div class="widget contact">
						...
						<div class="media-list">
							...
							<div class="clearfix"></div>
								<span id="siteseal"><script async type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=18e9LHCv2oNEQnm0CrT6GLS6lJE4WQYsUUHLpGMbsIWVwRYKfqYHvvK4SF7N"></script></span>
