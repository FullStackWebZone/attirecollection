            ...
            <div class="col-md-6 col-sm-12 col-xs-12">
                ...
                ?>
                    <div class="product-info">
                        ...
                        ||
                        <p>
                            <a href="<?php echo base_url(); ?>home/category/<?php echo $row['category']; ?>/<?php echo $row['sub_category']; ?>/<?php echo $row['sub_category']; ?>">
                                <?php echo $this->crud_model->get_type_name_by_id('sub_sub_category',$row['sub_sub_category'],'sub_sub_category_name');?>
                            </a>
                        </p>
                        ||
                        <?php $fourth = $this->crud_model->get_type_name_by_id('fourth_sub_category',$row['fourth_sub_category'],'fourth_sub_category_name');
                        if($fourth != ''){ ?>
                        <p>
                            <a href="<?php echo base_url(); ?>home/category/<?php echo $row['category']; ?>/<?php echo $row['sub_category']; ?>/<?php echo $row['sub_category']; ?>/<?php echo $row['sub_category']; ?>">
                                <?php echo $this->crud_model->get_type_name_by_id('fourth_sub_category',$row['fourth_sub_category'],'fourth_sub_category_name');?>
                            </a>
                        </p>
                        ||
                    <?php } ?>
