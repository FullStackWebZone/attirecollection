                ...
                <li>
                    ...
                    <ul class="children">
                        ...
                        <li class="on_click_search checkbox"
                            ...
                            </label>														<ul class="children">                        <?php                            $sub_sub_category = $this->db->get_where('sub_sub_category',array('sub_category'=>$row1['sub_category_id']))->result_array();                            foreach($sub_sub_category as $row2)                            {                        ?>                        <li class="on_click_search checkbox"                            data-min="<?php echo floor($this->crud_model->get_range_lvl('sub_sub_category', $row2['sub_sub_category_id'], "min")); ?>"                                 data-max="<?php echo ceil($this->crud_model->get_range_lvl('sub_sub_category', $row2['sub_sub_category_id'], "max")); ?>" >                            <label for="sub_sub_<?php echo $row2['sub_sub_category_id']; ?>" onClick="check(this)" >                                <input type="checkbox" name="jsut_show" id="sub_sub_<?php echo $row2['sub_sub_category_id']; ?>" class="search_sub_sub" value="<?php echo $row2['sub_sub_category_id']; ?>">                                <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>                                <?php echo $row2['sub_sub_category_name']; ?>                                <span class="count">                                   <?php echo $this->crud_model->is_publishable_count('sub_sub_category',$row2['sub_sub_category_id']); ?>                                </span>                            </label>                        </li>						<ul class="children">                        <?php                            $fourth_sub_category = $this->db->get_where('fourth_sub_category',array('sub_sub_category'=>$row2['sub_sub_category_id']))->result_array();                            foreach($fourth_sub_category as $row3)                            {                        ?>                        <li class="on_click_search checkbox"                            data-min="<?php echo floor($this->crud_model->get_range_lvl('fourth_sub_category', $row3['fourth_sub_category_id'], "min")); ?>"                                 data-max="<?php echo ceil($this->crud_model->get_range_lvl('fourth_sub_category', $row3['fourth_sub_category_id'], "max")); ?>" >                            <label for="sub_<?php echo $row3['fourth_sub_category_id']; ?>" onClick="check(this)" >                                <input type="checkbox" name="jsut_show" id="fourth_sub_<?php echo $row3['fourth_sub_category_id']; ?>" class="search_sub_fourth" value="<?php echo $row3['fourth_sub_category_id']; ?>">                                <span class="cr"><i class="cr-icon glyphicon glyphicon-ok"></i></span>                                <?php echo $row3['fourth_sub_category_name']; ?>                                <span class="count">                                   <?php echo $this->crud_model->is_publishable_count('fourth_sub_category',$row3['fourth_sub_category_id']); ?>                                </span>                            </label>                        </li>                        <?php                              }                        ?>                    </ul>                        <?php                              }                        ?>                    </ul>
                        </li>
                        <?php  
                            }
                        ?>
