...
?>
    ...
    <input type="hidden" name="sub_category" id="sub_categoryaa">		<input type="hidden" name="sub_sub_category" id="sub_sub_categoryaa">		<input type="hidden" name="fourth_sub_category" id="fourth_sub_categoryaa">	
...
<script>
	...
	var cur_sub_sub_category 	= '<?php echo $cur_sub_sub_category; ?>';	    
	var cur_fourth_sub_category 	= '<?php echo $cur_fourth_sub_category; ?>';
    ...
    $(document).ready(function(){
        ...
        $('.search_cat').on('click',function(event){
            if(!$(this).hasClass('arrow')){
				...
				$(this).closest('ul').find('.search_sub_sub').prop("checked", false);
				$(this).closest('ul').find('.search_sub_fourth').prop("checked", false);
				...
				if ($(".first_load_check").val() == 'no') {
					if(cur_sub_category == '0' || cur_sub_category == ''){
						...
						$(this).closest('li').find('.search_sub_sub').prop("checked", true);
						$(this).closest('li').find('.search_sub_fourth').prop("checked", true);
						...
						$("#sub_sub_" + cur_sub_sub_category).hide();
						$("#sub_sub_" + cur_sub_sub_category).prop("checked", true);							
						$("#sub_sub_" + cur_sub_sub_category).closest('label').find('.cr-icon').removeClass('remove');
						$("#sub_sub_" + cur_sub_sub_category).closest('label').find('.cr-icon').addClass('add');
						
						$("#fourth_sub_" + cur_fourth_sub_category).hide();
						$("#fourth_sub_" + cur_fourth_sub_category).prop("checked", true);							
						$("#fourth_sub_" + cur_fourth_sub_category).closest('label').find('.cr-icon').removeClass('remove');
						$("#fourth_sub_" + cur_fourth_sub_category).closest('label').find('.cr-icon').addClass('add');
					}
				} else {
					$(this).closest('li').find('.search_sub').prop("checked", true);
					$(this).closest('li').find('.cr-icon').removeClass('remove');
    ...
    function do_product_search(page){
		...
		$('#sub_sub_categoryaa').val($('.search_sub_sub:checked').map(function() {return this.value;}).get().join(','));
		$('#fourth_sub_categoryaa').val($('.search_sub_fourth:checked').map(function() {return this.value;}).get().join(','));
