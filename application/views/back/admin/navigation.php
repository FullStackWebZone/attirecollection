            ...
            <div class="nano">
                <div class="nano-content" style="overflow-x:auto;">
                    <ul id="mainnav-menu" class="list-group">
                            ...
                            <!--Menu list item-->
                                <li <?php if($page_name=="category" || 
                                    ...
                                    <ul class="collapse <?php if($page_name=="category" || 
                                        ...
                                        ?>
                                            <li <?php if($page_name=="sub_sub_category"){?> class="active-link" <?php } ?> >
                                                <a href="<?php echo base_url(); ?>admin/sub_sub_category">
                                                    <i class="fa fa-circle fs_i"></i>
                                                        <?php echo translate('sub-sub-category');?>
                                                </a>
                                            </li>
                                        <?php
                                        } if($this->crud_model->admin_permission('fourth_sub_category')){
                                        ?>
                                            <li <?php if($page_name=="fourth_sub_category"){?> class="active-link" <?php } ?> >
                                                <a href="<?php echo base_url(); ?>admin/fourth_sub_category">
                                                    <i class="fa fa-circle fs_i"></i>
                                                        <?php echo translate('fourth-sub-category');?>
                                                </a>
                                            </li>    
                                        <?php
                        ...
                        ?>
						 <?php
                            if($this->crud_model->admin_permission('country_based_sipping')){
                        ?>
                        <li <?php if($page_name=="country_based_shipping"){?> class="active-link" <?php } ?> >
