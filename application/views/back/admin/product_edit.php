                ...
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                        <div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border" id="sub" >
                                ...
                                <div class="col-sm-6" id="sub_cat">
                                    <?php echo $this->crud_model->select_html('sub_category','sub_category','sub_category_name','edit','demo-chosen-select required',$row['sub_category'],'category',$row['category'],'get_sub_cat'); ?>
                                </div>
                            </div>

                            <div class="form-group btm_border" id="sub_sub" >
                                <label class="col-sm-4 control-label" for="demo-hor-3"><?php echo translate('sub-sub-category');?></label>
                                <div class="col-sm-6" id="sub_sub_cat">
                                    <?php echo $this->crud_model->select_html('sub_sub_category','sub_sub_category','sub_sub_category_name','edit','demo-chosen-select',$row['sub_sub_category'],'sub_category',$row['sub_category'],'get_fourth_cat'); ?>
                                </div>
                            </div>

                            <div class="form-group btm_border" id="fourth_sub" >
                                <label class="col-sm-4 control-label" for="demo-hor-3"><?php echo translate('fourth-sub-category');?></label>
                                <div class="col-sm-6" id="fourth_sub_cat">
                                    <?php echo $this->crud_model->select_html('fourth_sub_category','fourth_sub_category','fourth_sub_category_name','edit','demo-chosen-select',$row['fourth_sub_category'],'sub_sub_category',$row['sub_sub_category'],'get_brnd'); ?>
                                </div>
                            </div>
                            ...
                            <div class="form-group btm_border" id="brn" >
                                ...
                                <div class="col-sm-6" id="brand" >
                                    <?php 
                                        $brands=json_decode($this->crud_model->get_type_name_by_id('brand','brand','brand'),true);
                                        if(count($brands)>0){
                        ...
                        <div id="business_details" class="tab-pane fade">
							...
							<div class="form-group btm_border">
                            <label class="col-sm-4 control-label" ><?php echo translate('shipping_cost_type');?></label>
                            <div class="col-sm-4">
                                <select name="shipping_cost_type" class="form-control" onchange="showCountry(this.value)">
									<option value="free" <?php echo $row['shipping_cost_type'] == 'free' ?'selected':''?>>
                                        	<?php echo translate('free');?>
                                    </option>
                                    <option value="product_wise" <?php echo $row['shipping_cost_type'] == 'product_wise' ?'selected':''?>>
                                        	<?php echo translate('product_wise');?>
                                    </option>
                                    <option value="country_wise" <?php echo $row['shipping_cost_type'] == 'country_wise' ?'selected':''?>>
                                        	<?php echo translate('country_wise');?>
                                    </option>
									<option value="product_country_wise" <?php echo $row['shipping_cost_type'] == 'product_country_wise' ?'selected':''?>>
                                        	<?php echo translate('product_+_country_wise');?>
                                    </option>
                                </select>
							...
							<div class="form-group btm_border product_country_shipping">
							<div class="col-sm-10 country-section">
							<?php
							 $shpping_country = $this->crud_model->get_shipping_list_by_productid($row['product_id']);
							 if(count($shpping_country) > 0){
								 ?>
								 <table class="table table-bordered" style="width:70%;margin-left:27%;">
								 <thead>
								 <tr>
								 <th>Country</th>
								 <th>Cost</th>
								 ...
								 <tbody>
								 <?php
								 foreach($shpping_country as $sh){
									 ?>
									 <tr>
									 <td><?php echo $sh['country_name']; ?></td>
									  <td><?php echo $sh['shipping_cost']; ?></td>
									 </tr>
									 <?php
								 }
								 ?>
							...
							<a class="btn btn-primary" style="margin-left:23%;margin-bottom:3%;" data-toggle="modal" data-target="#shippingModal">Add</a>
							</div>
							...
							<div class="form-group btm_border">
                                <label class="col-sm-4 control-label" for="demo-hor-8"><?php echo translate('bundle_shipping_cost');?></label>
                                <div class="col-sm-4">
                                    <input type="number" name="bundle_shipping_cost" min='0' id="demo-hor-8" min='0' step='.01' value="<?php echo $row['bundle_shipping_cost']; ?>" placeholder="<?php echo translate('bundle_shipping_cost');?>" class="form-control">
                                </div>
								<div class="col-sm-1">
                                <span class="btn"><?php echo currency('','def'); ?> 
							</span>
							</div>
							<div class="col-sm-2">
							<select class="form-control" name="bundle_shipping_qty">
							<option value="">Select</option>
							<option value="5" <?php echo $row['bundle_shipping_qty'] == 5?'selected':''?>>5 pcs</option>
							<option value="10" <?php echo $row['bundle_shipping_qty'] == 10 ?'selected':''?>>10 pcs</option>
							<option value="15"  <?php echo $row['bundle_shipping_qty'] == 15 ?'selected':''?>>15 pcs</option>
							<option value="20" <?php echo $row['bundle_shipping_qty'] == 20 ?'selected':''?>>20 pcs</option>
							</select>
							</div>							
							...
							<div id="shippingModal" class="modal fade" role="dialog">
							  <div class="modal-dialog">
								...
								<div class="modal-content">
								  ...
								  <?php
									echo form_open(base_url() . 'admin/shipping/ajax_add/', array(
										'class' => 'form-horizontal',
										'method' => 'post',
										'id' => 'shipping_add'
									));
									?>
									 <div class="form-group">
									   ...
									   <div class="col-sm-6">
										...
										<input type="hidden" value="<?php echo $row['product_id']; ?>" name="shipping_product_id">
									</div>
									 <div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text"  name="product_shipping_cost" id="demo-hor-4" class="form-control required" placeholder="<?php echo translate('shipping cost'); ?>">
										</div>
									</div>
									 <div class="form-group">
										 <div class="col-sm-10 text-right">
										 <input type="submit" name="submit" class="btn btn-primary" value="Save" onclick="saveShipping()">
										 </div>
									 </div>
									 </form>
								  </div>
...
<script type="text/javascript">
	...
	function saveShipping(){
		$.ajax({
				url:$("#shipping_add").attr('action'),
				data : $("#shipping_add").serialize(),
				type:'post',
				success: function(data) {
					console.log(data);
					var list = JSON.parse(data);
					html = "";
					html += '<table class="table table-bordered" style="width:70%;margin-left:27%;">';
					html += '<tr>';
					html += '<th>Country</th>';
					html += '<th>Cost</th></tr>';
					for(var i = 0; i<list.length ; i++){
						console.log(list[i]);
						html += '<tr>';
						html += '<td>'+list[i]['country_name']+'</td>';
						html += '<td>'+list[i]['shipping_cost']+'</td>';
						html += '</tr>';
					}
					html += '</table>';
					$(".country-section").html(html);
    ...
    function get_cat(id){
     ...
     function get_sub_cat(id){
        $('#fourth_sub').hide('slow');
        $('#sub_sub').hide('slow');
        ajax_load(base_url+'admin/product/sub_sub_by_cat/'+id,'sub_sub_cat','other');
        $('#sub_sub').show('slow');
    }

    function get_fourth_cat(id){
        $('#brn').hide('slow');
        $('#fourth_sub').hide('slow');
        ajax_load(base_url+'admin/product/fourth_sub_by_cat/'+id,'fourth_sub_cat','other');
        $('#fourth_sub').show('slow');
    }
	...
	function showCountry(val){
		if(val == 'country_wise' || val == 'product_country_wise' ){
			$(".product_country_shipping").show();
			
		}else{
			$(".product_country_shipping").hide();
		}
	}
</script>
<style>
