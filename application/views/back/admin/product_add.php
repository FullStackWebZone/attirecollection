                ...
                <div class="tab-base">
                    ...
                    <div class="tab-content">
                    	<div id="product_details" class="tab-pane fade active in">
                            ...
                            <div class="form-group btm_border" id="sub_sub" style="display:none;">
                             ...
                             <div class="form-group btm_border" id="fourth_sub" style="display:none;">
                        ...
                        <div id="business_details" class="tab-pane fade">
                            ...
                            <div class="col-sm-4">
                                <select name="shipping_cost_type" class="form-control" onchange="showCountry(this.value)">
                                    ...
                                    <option value="country_wise">
                                        	<?php echo translate('country_wise');?>
                                    </option>
									<option value="product_country_wise">
...
<script>
    ...
    function get_fourth_cat(id,now){
