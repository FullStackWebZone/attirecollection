<div>
    <?php
		echo form_open(base_url() . 'admin/sub_sub_category/do_add/', array(
			'class' => 'form-horizontal',
			'method' => 'post',
			'id' => 'sub_sub_category_add',
	...
	?>
        <div class="panel-body">
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" name="sub_sub_category_name" placeholder="<?php echo translate('sub-sub-category_name'); ?>" class="form-control required">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-4 control-label" for="demo-hor-2">
                    <?php echo translate('sub-sub-category_banner');?>
                </label>
                <div class="col-sm-6">
                    <span class="pull-left btn btn-default btn-file">
                        <?php echo translate('select_sub-sub-category_banner');?>
                        <input type="file" name="img" id='imgInp' accept="image">
                    </span>
                    <br><br>
                    <span id='wrap' class="pull-left" >
                        <img src="<?php echo base_url(); ?>uploads/sub_sub_category_image/default.jpg" 
                            width="100%" id='blah' > 
                    </span>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <?php echo $this->crud_model->select_html('sub_category','sub_category','sub_category_name','add','demo-chosen-select required','','digital',NULL); ?>
                </div>
            </div>
			<div class="form-group">
