<div id="content-container">
	<div id="page-title">
		...
		<?php echo translate('manage_shipping');?>
		</h1>
	</div>
	<div class="tab-base">
		<div class="panel">
				...
				<div class="tab-content">
					<div class="col-md-12" 
						...
						<button class="btn btn-primary btn-labeled fa fa-plus-circle pull-right mar-rgt"
                        	onclick="ajax_modal('add','<?php echo translate('add_shipping');?>','<?php echo translate('successfully_added!');?>','shipping_add','')" >
							<?php echo translate('create_shipping');?>
						</button>
					</div>
					<br>
