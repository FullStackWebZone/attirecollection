                    ...
                    <div class="panel panel-bordered panel-dark">
                        ...
                        <div class="panel-body" style="background:#fffffb;">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select name="shipping_cost_type" class="demo-cs-multiselect">
                                        ...
                                        <option value="fixed" 
                                            ...
                                            <?php if($sp_type == 'country_wise'){ echo 'selected'; } ?> >
							 ...
							 <div class="form-group">
                                <label class="col-sm-3 control-label" ><?php echo translate('min_cart_amount');?></label>
                                <div class="col-sm-6">
                                    <input type="text" name="min_cart_amount" 
                                        value="<?php echo $min_cart_amount; ?>" 
                                            class="form-control">
                                </div>
                            </div>
