...
class Admin extends CI_Controller
{
    ...
    /*Product Sub-sub-category add, edit, view, delete */
    function sub_sub_category($para1 = '', $para2 = '')
    {
        if (!$this->crud_model->admin_permission('sub_sub_category')) {
            redirect(base_url() . 'admin');
        }
        if ($this->crud_model->get_type_name_by_id('general_settings','68','value') !== 'ok') {
            redirect(base_url() . 'admin');
        ...
        if ($para1 == 'do_add') {
            $data['sub_sub_category_name'] = $this->input->post('sub_sub_category_name');
            ...
            $path = $_FILES['img']['name'];
            $ext = pathinfo($path, PATHINFO_EXTENSION);
            $data_banner['banner']       = 'sub_sub_category_'.$id.'.'.$ext;
            $this->crud_model->file_up("img", "sub_sub_category", $id, '', 'no', '.'.$ext);
            $this->db->where('sub_sub_category_id', $id);
            $this->db->update('sub_sub_category', $data_banner);
            $this->crud_model->set_category_data(0);
            
            recache();
        } else if ($para1 == 'edit') {
            $page_data['sub_sub_category_data'] = $this->db->get_where('sub_sub_category', array(
                'sub_sub_category_id' => $para2
            ))->result_array();
            $this->load->view('back/admin/sub_sub_category_edit', $page_data);
        } elseif ($para1 == "update") {
            $data['sub_sub_category_name'] = $this->input->post('sub_sub_category_name');
            $data['sub_category']          = $this->input->post('sub_category');
            $data['affiliation']       = $this->input->post('affiliation') ? 1 :0 ;
            ...
            $this->db->where('sub_sub_category_id', $para2);
            $this->db->update('sub_sub_category', $data);
            
            if($_FILES['img']['name']!== ''){
                $path = $_FILES['img']['name'];
                $ext = pathinfo($path, PATHINFO_EXTENSION);
                $data_banner['banner']       = 'sub_sub_category_'.$para2.'.'.$ext;
                $this->crud_model->file_up("img", "sub_sub_category", $para2, '', 'no', '.'.$ext);
                $this->db->where('sub_sub_category_id', $para2);
                $this->db->update('sub_sub_category', $data_banner);
            }
            $this->crud_model->set_category_data(0);
            ...
            unlink("uploads/sub_sub_category_image/" .$this->crud_model->get_type_name_by_id('sub_sub_category',$para2,'banner'));
            $this->db->where('sub_sub_category_id', $para2);
            $this->db->delete('sub_sub_category');
            $this->crud_model->set_category_data(0);
            recache();
        } elseif ($para1 == 'list') {
            $this->db->order_by('sub_sub_category_id', 'desc');
            $this->db->where('digital=',NULL);
            $page_data['all_sub_sub_category'] = $this->db->get('sub_sub_category')->result_array();
            $this->load->view('back/admin/sub_sub_category_list', $page_data);
        } elseif ($para1 == 'add') {
            $this->load->view('back/admin/sub_sub_category_add');
        } else {
            $page_data['page_name']        = "sub_sub_category";
            $page_data['all_sub_sub_category'] = $this->db->get('sub_sub_category')->result_array();
            $this->load->view('back/index', $page_data);
        }
    }
    ...
    /*Product Sub-sub-category add, edit, view, delete */
    function fourth_sub_category($para1 = '', $para2 = '')
    {
        if (!$this->crud_model->admin_permission('fourth_sub_category')) {
            redirect(base_url() . 'admin');
        }
        if ($this->crud_model->get_type_name_by_id('general_settings','68','value') !== 'ok') {
            redirect(base_url() . 'admin');
        ...
        if ($para1 == 'do_add') {
            $data['fourth_sub_category_name'] = $this->input->post('fourth_sub_category_name');
            ...
            $this->db->insert('fourth_sub_category', $data);
            $id = $this->db->insert_id();
            
            $path = $_FILES['img']['name'];
            $ext = pathinfo($path, PATHINFO_EXTENSION);
            $data_banner['banner']       = 'fourth_sub_category_'.$id.'.'.$ext;
            $this->crud_model->file_up("img", "fourth_sub_category", $id, '', 'no', '.'.$ext);
            $this->db->where('fourth_sub_category_id', $id);
            $this->db->update('fourth_sub_category', $data_banner);
            $this->crud_model->set_category_data(0);
            
            recache();
        } else if ($para1 == 'edit') {
            $page_data['fourth_sub_category_data'] = $this->db->get_where('fourth_sub_category', array(
                'fourth_sub_category_id' => $para2
            ))->result_array();
            $this->load->view('back/admin/fourth_sub_category_edit', $page_data);
        } elseif ($para1 == "update") {
            $data['fourth_sub_category_name'] = $this->input->post('fourth_sub_category_name');
            $data['sub_sub_category']          = $this->input->post('sub_sub_category');
            $data['affiliation']       = $this->input->post('affiliation') ? 1 :0 ;
            ...
            $this->db->where('fourth_sub_category_id', $para2);
            $this->db->update('fourth_sub_category', $data);
            
            if($_FILES['img']['name']!== ''){
                $path = $_FILES['img']['name'];
                $ext = pathinfo($path, PATHINFO_EXTENSION);
                $data_banner['banner']       = 'fourth_sub_category_'.$para2.'.'.$ext;
                $this->crud_model->file_up("img", "fourth_sub_category", $para2, '', 'no', '.'.$ext);
                $this->db->where('fourth_sub_category_id', $para2);
                $this->db->update('fourth_sub_category', $data_banner);
            }
            $this->crud_model->set_category_data(0);
            ...
            unlink("uploads/fourth_sub_category_image/" .$this->crud_model->get_type_name_by_id('fourth_sub_category',$para2,'banner'));
            $this->db->where('fourth_sub_category_id', $para2);
            $this->db->delete('fourth_sub_category');
            $this->crud_model->set_category_data(0);
            recache();
        } elseif ($para1 == 'list') {
            $this->db->order_by('fourth_sub_category_id', 'desc');
            $this->db->where('digital=',NULL);
            $page_data['all_fourth_sub_category'] = $this->db->get('fourth_sub_category')->result_array();
            $this->load->view('back/admin/fourth_sub_category_list', $page_data);
        } elseif ($para1 == 'add') {
            $this->load->view('back/admin/fourth_sub_category_add');
        } else {
            $page_data['page_name']        = "fourth_sub_category";
            $page_data['all_fourth_sub_category'] = $this->db->get('fourth_sub_category')->result_array();
            $this->load->view('back/index', $page_data);
        }
    }
    ...
    function product($para1 = '', $para2 = '', $para3 = '')
    {
        ...
        if ($para1 == 'do_add') {
            ...
            $data['sub_category']       = $this->input->post('sub_category');
            $data['sub_sub_category']       = $this->input->post('sub_sub_category');
            $data['fourth_sub_category']       = $this->input->post('fourth_sub_category');
			...
			$data['shipping_cost_type']      = $this->input->post('shipping_cost_type');
            $data['bundle_shipping_cost']      = $this->input->post('bundle_shipping_cost');
            $data['bundle_shipping_qty']      = $this->input->post('bundle_shipping_qty');
            ...
            echo $this->crud_model->select_html('sub_category', 'sub_category', 'sub_category_name', 'add', 'demo-chosen-select required', '', 'category', $para2, 'get_sub_cat');
        }elseif ($para1 == 'sub_sub_by_cat') {
            echo $this->crud_model->select_html('sub_sub_category', 'sub_sub_category', 'sub_sub_category_name', 'add', 'demo-chosen-select', '', 'sub_category', $para2, 'get_fourth_cat');
        }elseif ($para1 == 'fourth_sub_by_cat') {
            echo $this->crud_model->select_html('fourth_sub_category', 'fourth_sub_category', 'fourth_sub_category_name', 'add', 'demo-chosen-select', '', 'sub_sub_category', $para2, 'get_brnd');
        } elseif ($para1 == 'brand_by_sub') {
            $brands=json_decode($this->crud_model->get_type_name_by_id('brand','brand','name'),true);
    ...
    public function product_bulk_upload()
    {
        ...
        $physical_sub_sub_categories =  $this->db->where('digital',null)->or_where('digital','')->get('sub_sub_category')->result_array();
        $physical_fourth_sub_categories =  $this->db->where('digital',null)->or_where('digital','')->get('fourth_sub_category')->result_array();
        ...
        $page_data['physical_sub_sub_categories'] = $physical_sub_sub_categories;
        $page_data['physical_fourth_sub_categories'] = $physical_fourth_sub_categories;
    ...
    public function product_bulk_upload_save_single($product)
    {
        ...
        $product_data['sub_sub_category'] = is_numeric($product['sub_sub_category']) ? $product['sub_sub_category'] : 0;
        $product_data['fourth_sub_category'] = is_numeric($product['fourth_sub_category']) ? $product['fourth_sub_category'] : 0;
        ...
        if($product_data['current_stock'] > 0){
            ...
            $product_stock_data['sub_sub_category'] = $product_data['sub_sub_category'];
            $product_stock_data['fourth_sub_category'] = $product_data['fourth_sub_category'];
    ...
    function customer_products($para1 = '', $para2 = '', $para3 = '')
    {
        ...
        if ($para1 == 'view') {
            ...
            echo $this->crud_model->select_html('sub_sub_category', 'sub_sub_category', 'sub_sub_category_name', 'add', 'demo-chosen-select', '', 'sub_category', $para2, 'get_brnd');
        }elseif ($para1 == 'fourth_sub_by_cat') {
            echo $this->crud_model->select_html('fourth_sub_category', 'fourth_sub_category', 'fourth_sub_category_name', 'add', 'demo-chosen-select', '', 'sub_category', $para2, 'get_brnd');
        }  elseif ($para1 == 'brand_by_sub') {
   ...
   /* Manage Frontend Captcha Settings Credentials */
    ...
    function business_settings($para1 = "", $para2 = "", $para3 = "")
    {
        if (!$this->crud_model->admin_permission('business_settings')) {
            ...
            $this->db->update('business_settings', array(
			 ...
			 $this->db->where('type', "min_cart_amount");
            $this->db->update('business_settings', array(
                'value' => $this->input->post('min_cart_amount')
            ));
	...
	function shipping($para1 = '', $para2 = '')
    {
		//$this->email_model->newsletter('admin', 'text','susharchana28@gmail.com', 'attirecollectio20@gmail.com');
		//die();
        if (!$this->crud_model->admin_permission('admin')) {
            redirect(base_url() . 'admin');
        }
		if ($para1 == 'ajax_add') {
			 $res = $this->db->get_where('country_shipping_charges', array(
                'country_id' => $this->input->post('country_id'),
				'product_id' => $this->input->post('shipping_product_id'),
            ));
			
			if($res->num_rows() > 0){
				$res = $res->row_array();
				$data['shipping_cost']     = $this->input->post('product_shipping_cost');
				$this->db->where('shipping_id',  $res['shipping_id']);
				$this->db->update('country_shipping_charges', $data);
			}else{
				$data['country_id']      = $this->input->post('country_id');
				$data['product_id']      = $this->input->post('shipping_product_id');
				$data['shipping_cost']     = $this->input->post('product_shipping_cost');
				$this->db->insert('country_shipping_charges', $data);
			}
			$list  = $this->crud_model->get_shipping_list_by_productid($this->input->post('shipping_product_id'));
            ...
            $page_data['shipping_data'] = $this->db->get_where('country_shipping_charges', array(
                'shipping_id' => $para2
            ))->result_array();
			 
            $this->load->view('back/admin/shipping_edit', $page_data);
        } elseif ($para1 == "update") {
            $data['country_id']      = $this->input->post('country_id');
            $data['shipping_cost']     = $this->input->post('shipping_cost');
            $this->db->where('shipping_id', $para2);
            $this->db->update('country_shipping_charges', $data);
            
        } elseif ($para1 == 'delete') {
            $this->db->where('shipping_id', $para2);
            $this->db->delete('country_shipping_charges');
        } elseif ($para1 == 'list') {
            $this->db->order_by('shipping_id', 'desc');
            $page_data['list'] = $this->crud_model->get_shipping_list();
            $this->load->view('back/admin/shipping_list', $page_data);
        } elseif ($para1 == 'add') {
            $this->load->view('back/admin/shipping_add');
        } else {
